        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ">
                ...
                <li class="nav-item" active style="font-size: 20px; padding-right: 50px;">
                    ...
                    <a class="nav-link" href="{{route('principal')}}"> <svg style="margin-bottom: 3px;" width="1.1em" height="1em" viewBox="0 0 16 16" class="bi bi-house" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

    ...
    <div class="container my-3 w-75 border border-dark rounded shadow p-3 mb-5 bg-white rounded" style=" padding: 20px;  ">
        ...
        <form action="formulario.php" method="POST">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    <div class="col-12">
                        ...
                        <input class="form-control" type="text" name="cpf" id="cpf" placeholder="   .   .   -  " minlength="11" maxlength="11">
                    </div>
                    <div class="col-12">
                        <label for="rg">RG:</label>
                        <input class="form-control" type="text" name="rg" id="rg" placeholder="  -  .   .   " minlength="8" maxlength="10">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="form-group">
                    <div class="col-12">
                        ...
                        <input type="date" class="form-control" name="dataNasc" id="nasc" placeholder="  /  /    " minlength="8" maxlength="8">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="nacionalidade" id="nacionalidade" placeholder="País de nascimento">
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="password" name="senha" id="senha" placeholder="********" minlength="6" maxlength="8">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="submit" class="btn btn-primary" value="Cadastrar" onclick="return cadastrar()">

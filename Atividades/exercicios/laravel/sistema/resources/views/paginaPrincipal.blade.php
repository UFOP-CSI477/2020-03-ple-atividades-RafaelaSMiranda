...
<body>
    ...
    <div class="jumbotron bg-light ">
        <h1 class="display-4 text-center">Exercicio utilizando Laravel</h1>
        <hr class="my-2">
        <p class="lead text-center">Aqui será abordado as aplicações de CRUD para todas as tabelas e relações desenvoldidas, dentre outras funcionalidades</p>
    </div>
